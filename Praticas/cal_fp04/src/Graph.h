...
bool Graph<T>::addEdge(const T &sourc, const T &dest, double w) {
    ...
    Vertex<T> * sourceV, *destV;
    if((sourceV = findVertex(sourc)) == NULL || (destV = findVertex(dest)) == NULL )
        return false;


    sourceV->addEdge(destV,w);
    return true;
...
bool Graph<T>::removeEdge(const T &sourc, const T &dest) {
    ...
    if((sourceV = findVertex(sourc)) == NULL || (destV = findVertex(dest)) == NULL)
        ...
        return sourceV->removeEdgeTo(destV);
    }
...
bool Vertex<T>::removeEdgeTo(Vertex<T> *d) {
    ...
    for(typename vector<Edge<T>>::iterator p = adj.begin(); p!= adj.end(); p++) {
